...
public class BiomeJurassicRedwoodHills extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_redwood_hills")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicRedwoodHills(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			setRegistryName("lepidodendron:jurassic_redwood_hills");
