...
public class BiomeJurassicCreekFloodplain extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_creek_floodplain")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicCreekFloodplain(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic Floodplain Creek").setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.9F).setRainfall(0.9F));
			setRegistryName("lepidodendron:jurassic_creek_floodplain");
