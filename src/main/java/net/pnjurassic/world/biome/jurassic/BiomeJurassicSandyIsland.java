...
public class BiomeJurassicSandyIsland extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_island_sandy")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicSandyIsland(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic Sandy Atolls").setBaseHeight(-0.3F).setHeightVariation(0F).setTemperature(1.9F));
			setRegistryName("lepidodendron:jurassic_island_sandy");
