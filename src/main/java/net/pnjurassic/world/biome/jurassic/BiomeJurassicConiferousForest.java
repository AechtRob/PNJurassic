...
public class BiomeJurassicConiferousForest extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_coniferous_forest")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicConiferousForest(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			setRegistryName("lepidodendron:jurassic_coniferous_forest");
