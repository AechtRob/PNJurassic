...
public class BiomeJurassicConiferousMountains extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_coniferous_mountains")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicConiferousMountains(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic Coniferous Mountains").setBaseHeight(3.85F).setHeightVariation(0.620F).setTemperature(-0.25F).setSnowEnabled());
			setRegistryName("lepidodendron:jurassic_coniferous_mountains");
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if (net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 6; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					LEAVES_GENERATOR.generate((BlockBush) BlockCephalotaxusSapling.block, BlockCephalotaxusLeaves.block.getDefaultState(), BlockCephalotaxusLog.block.getDefaultState().withProperty(BlockCephalotaxusLog.BlockCustom.FACING, EnumFacing.NORTH), worldIn, rand, pos.add(j, l, k), 0, 110);
				}
