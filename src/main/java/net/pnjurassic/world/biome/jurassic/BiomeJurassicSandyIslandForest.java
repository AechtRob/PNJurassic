...
public class BiomeJurassicSandyIslandForest extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_island_sandy_forest")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicSandyIslandForest(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic Sandy Atolls").setBaseHeight(0.05F).setHeightVariation(0F).setTemperature(1.9F));
			setRegistryName("lepidodendron:jurassic_island_sandy_forest");
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 22; ++i)
				{
					...
					STATIC_GENERATOR.generate(BlockBivalveLithiotis.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 12, 255, 0, 255);
				}
