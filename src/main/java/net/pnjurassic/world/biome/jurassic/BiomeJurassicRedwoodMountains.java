...
public class BiomeJurassicRedwoodMountains extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_redwood_mountains")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicRedwoodMountains(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			setRegistryName("lepidodendron:jurassic_redwood_mountains");
