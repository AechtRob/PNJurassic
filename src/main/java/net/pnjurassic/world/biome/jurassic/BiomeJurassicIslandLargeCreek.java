...
public class BiomeJurassicIslandLargeCreek extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_island_large_creek")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicIslandLargeCreek(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			setRegistryName("lepidodendron:jurassic_island_large_creek");
