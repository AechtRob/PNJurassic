...
public class BiomeJurassicCreekSouthernTaiga extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_creek_southern_taiga")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicCreekSouthernTaiga(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Jurassic Southern Taiga Creek").setTemperature(0.225F).setRainfall(0.8F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setWaterColor(-5317633));
			setRegistryName("lepidodendron:jurassic_creek_southern_taiga");
