...
public class BiomeJurassicIslandLargeScrub extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_island_large_scrub")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicIslandLargeScrub(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Caldera Island Interior").setBaseHeight(0.2F).setHeightVariation(0.095F).setTemperature(2.0F).setRainfall(0.8F));
			setRegistryName("lepidodendron:jurassic_island_large_scrub");
...
//					int k = rand.nextInt(16) + 8;
//					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
//					PLANT_GENERATOR.generate(BlockDayvaultia.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 0, 255, true);
//				}
//
//			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
//				for (int i = 0; i < 10; ++i)
