...
public class BiomeJurassicIslandLargeRimRoost extends ElementsLepidodendronMod.ModElement {
	...
	public BiomeJurassicIslandLargeRimRoost(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Caldera Island Cliffs Roost").setBaseHeight(3.8F).setHeightVariation(0.3F).setTemperature(2.0F).setRainfall(0.8F));
			...
			if (net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.ICE)) {
				{
					...
					for (int j = 0; j < 24; ++j)
					{
						...
						GUANO_GENERATOR.generate(worldIn, rand, blockpos, 136);
					}
				}
			}
