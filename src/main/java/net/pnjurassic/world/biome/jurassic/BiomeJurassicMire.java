...
public class BiomeJurassicMire extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_mire")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicMire(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
