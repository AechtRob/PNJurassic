...
public class BiomeJurassicMireHelper extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_mire_helper")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicMireHelper(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			setRegistryName("lepidodendron:jurassic_mire_helper");
