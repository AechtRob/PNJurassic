...
public class BiomeJurassicLake extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_lakes")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicLake(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic Lakes").setBaseHeight(-0.76F).setHeightVariation(0.285F).setTemperature(0.8F).setRainfall(0.9F));
			setRegistryName("lepidodendron:jurassic_lakes");
