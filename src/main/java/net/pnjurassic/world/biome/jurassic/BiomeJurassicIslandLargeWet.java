...
public class BiomeJurassicIslandLargeWet extends ElementsLepidodendronMod.ModElement {
	...
	public BiomeJurassicIslandLargeWet(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Caldera Island Interior").setBaseHeight(-0.15F).setHeightVariation(0.00F).setTemperature(2.0F).setRainfall(0.8F));
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
			{
				for (int j1 = 0; j1 < 16; ++j1)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					this.PODZOL_GENERATOR.generate(worldIn, rand, pos.add(j, l, k));
				}
			}
