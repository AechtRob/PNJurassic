...
public class BiomeJurassicDesertRimDesertSide extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_desert_rim_desert_side")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicDesertRimDesertSide(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
