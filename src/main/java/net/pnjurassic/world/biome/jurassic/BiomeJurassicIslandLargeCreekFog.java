...
public class BiomeJurassicIslandLargeCreekFog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_island_large_creek_fog")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicIslandLargeCreekFog(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Caldera Island Creek").setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(2.0F).setRainfall(0.8F));
			setRegistryName("lepidodendron:jurassic_island_large_creek_fog");
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
			{
				for (int j1 = 0; j1 < 5; ++j1)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					SILT_PATCH_GENERATOR.generate(worldIn, rand, pos.add(j, l, k));
				}
			}
