...
public class BiomeJurassicCreekGinkgoWoodland extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_creek_ginkgo_woodland")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicCreekGinkgoWoodland(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic Ginkgo Woodland Creek").setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.8F).setRainfall(0.9F));
			setRegistryName("lepidodendron:jurassic_creek_ginkgo_woodland");
