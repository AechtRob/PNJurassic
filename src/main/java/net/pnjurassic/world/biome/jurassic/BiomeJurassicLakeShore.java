...
public class BiomeJurassicLakeShore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_lake_shore")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicLakeShore(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic Lakes").setBaseHeight(0F).setHeightVariation(0.2F).setTemperature(0.8F).setRainfall(0.9F));
			setRegistryName("lepidodendron:jurassic_lake_shore");
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 4; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					LEAVES_GENERATOR.generate((BlockBush) BlockScrubbyPineSapling.block, BlockScrubbyPineLeaves.block.getDefaultState(), BlockScrubbyPineLog.block.getDefaultState().withProperty(BlockScrubbyPineLog.BlockCustom.FACING, EnumFacing.NORTH), worldIn, rand, pos.add(j, l, k), 0, 110);
				}
...
//				}
		...
		public EnumBiomeTypeJurassic getBiomeType() {
			return EnumBiomeTypeJurassic.Lake;
		}
