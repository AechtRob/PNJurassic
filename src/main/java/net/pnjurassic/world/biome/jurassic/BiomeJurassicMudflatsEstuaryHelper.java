...
public class BiomeJurassicMudflatsEstuaryHelper extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_mudflats_estuary_helper")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicMudflatsEstuaryHelper(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic Mudflats").setBaseHeight(0.035F).setHeightVariation(0F).setTemperature(1.25F).setRainfall(0.4F));
			setRegistryName("lepidodendron:jurassic_mudflats_estuary_helper");
