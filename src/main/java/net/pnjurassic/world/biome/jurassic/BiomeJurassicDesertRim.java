...
public class BiomeJurassicDesertRim extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_desert_rim")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicDesertRim(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			setRegistryName("lepidodendron:jurassic_desert_rim");
