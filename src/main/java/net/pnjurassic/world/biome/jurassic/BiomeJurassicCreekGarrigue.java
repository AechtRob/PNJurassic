...
public class BiomeJurassicCreekGarrigue extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_creek_garrigue")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicCreekGarrigue(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Garrigue Creek").setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.7F).setRainfall(0.8F));
			setRegistryName("lepidodendron:jurassic_creek_garrigue");
