...
public class BiomeJurassicCreekFernPasture extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_creek_fern_pasture")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicCreekFernPasture(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Fern Pasture Creek").setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.85F).setRainfall(0.4F));
			setRegistryName("lepidodendron:jurassic_creek_fern_pasture");
