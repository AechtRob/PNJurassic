...
public class BiomeJurassicOceanRafts extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_ocean_rafts")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicOceanRafts(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
