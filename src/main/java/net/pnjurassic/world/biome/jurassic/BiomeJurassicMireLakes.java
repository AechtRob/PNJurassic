...
public class BiomeJurassicMireLakes extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_mire_lakes")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicMireLakes(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Horsetail Mire").setBaseHeight(-0.56F).setHeightVariation(0.0F).setTemperature(1.0F).setRainfall(0.5F));
			setRegistryName("lepidodendron:jurassic_mire_lakes");
		...
		public EnumBiomeTypeJurassic getBiomeType() {
			return EnumBiomeTypeJurassic.Mire;
		}
