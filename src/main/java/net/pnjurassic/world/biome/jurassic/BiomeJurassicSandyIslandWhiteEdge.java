...
public class BiomeJurassicSandyIslandWhiteEdge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_island_sandy_white_edge")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicSandyIslandWhiteEdge(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic Windswept Isles").setBaseHeight(-0.60F).setHeightVariation(0F).setTemperature(1.9F));
			setRegistryName("lepidodendron:jurassic_island_sandy_white_edge");
