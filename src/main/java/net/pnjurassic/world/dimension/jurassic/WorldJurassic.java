...
public class WorldJurassic extends ElementsLepidodendronMod.ModElement {
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public Biome getBiomeForCoordsBody(final BlockPos pos, World worldIn)
		{
			...
			{
				return worldIn.provider.getBiomeProvider().getBiome(pos, BiomeJurassicOceanShore.biome);
			}
		}
		...
		public Biome getBiome(Chunk chunk, BlockPos pos, BiomeProvider provider)
		{
			...
			if (k == 255)
			{
				...
				Biome biome = world.isRemote ? BiomeJurassicOceanShore.biome : provider.getBiome(pos, BiomeJurassicOceanShore.biome);
				k = Biome.getIdForBiome(biome);
				chunk.getBiomeArray()[j << 4 | i] = (byte)(k & 255);
			}

			Biome biome1 = Biome.getBiome(k);
			return biome1 == null ? BiomeJurassicOceanShore.biome : biome1;
		}
