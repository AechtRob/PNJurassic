...
public class GenLayerDiversifyJurassicSandbanks3 extends GenLayer {
    ...
    public Biome JURASSIC_SANDBANKS_SOLID = Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:jurassic_sandbanks_solid"));
    ...
    public GenLayerDiversifyJurassicSandbanks3(long seed, GenLayer genlayer) {
        super(seed);
