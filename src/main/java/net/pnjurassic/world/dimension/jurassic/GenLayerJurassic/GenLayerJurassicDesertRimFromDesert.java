...
public class GenLayerJurassicDesertRimFromDesert extends GenLayer
{
    ...
    public GenLayerJurassicDesertRimFromDesert(long seed, GenLayer genLayer)
    {
        super(seed);
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                if (isDesert(k))
                {
                    ...
                    {
                        aint1[j + i * areaWidth] = DESERT_TRANSITION_DESERT_SIDE_ID;
                    }
                    else
                    {
